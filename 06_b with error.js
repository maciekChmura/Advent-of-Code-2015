...
for (var a = 0; a < arr.length - 1; a++) {          //read data
        ...
        for (var l = 0; l < zeroGrid[k].length; l++) {
            if (arr[a][0] === "turnoff") {
                if (inputGrid[k][l] === 1 && zeroGrid[k][l] > 0) {
                    zeroGrid[k][l] = zeroGrid[k][l] - 1;
                } else if (inputGrid[k][l] === 1 && zeroGrid[k][l] <= 0) {
                    zeroGrid[k][l] = 0;
                }
                ...
                if (inputGrid[k][l] === 1) { //toggle zwieksza o 2
                    zeroGrid[k][l] = zeroGrid[k][l] + 2;
